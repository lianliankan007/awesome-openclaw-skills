...
- [devialet](https://github.com/openclaw/skills/tree/main/skills/jgm2025/devialet/SKILL.md) - 通过 HTTP API 控制 Devial​​​​et Phantom 扬声器。
- [dht11-temp](https://github.com/openclaw/skills/tree/main/skills/noahseeger/dht11-temp/SKILL.md) - 从 DHT11 传感器读取温度和湿度。
- [dirigera-control](https://github.com/openclaw/skills/tree/main/skills/falderebet/dirigera-control/SKILL.md) - 控制 IKEA Direct 智能家居设备。
...
- [icom-7610](https://github.com/openclaw/skills/tree/main/skills/morozsm/icom-7610/SKILL.md) - 通过 USB/LAN 控制 Icom IC-7610 收发器。
- [internet-lookup-verifier](https://github.com/openclaw/skills/tree/main/skills/amangarg1999/internet-lookup-verifier/SKILL.md) - 通过执行来验证信息。
- [ipcam](https://github.com/openclaw/skills/tree/main/skills/ltpop/ipcam/SKILL.md) - ONVIF PTZ 控制 + RTSP 捕获 + 摄像机发现。
- [lg-thinq](https://github.com/openclaw/skills/tree/main/skills/kaiofreitas/lg-thinq/SKILL.md) - 通过 ThinQ API 控制 LG 智能电器。
- [lygo-champion-cosmara](https://github.com/openclaw/skills/tree/main/skills/deepseekoracle/lygo-champion-cosmara/SKILL.md) - COSMARA – ARKOS 系列 LYGO 道德宇宙探索的冠军。
- [nest-sdm](https://github.com/openclaw/skills/tree/main/skills/tag-assistant/nest-sdm/SKILL.md) - 通过 Google 智能设备管理 (SDM) API 控制 Nest 恒温器、门铃和摄像头。
- [nostr-plantr](https://github.com/openclaw/skills/tree/main/skills/samthomson/nostr-plantr/SKILL.md) - Plantr IoT 数据的专业技能（种类 34419 和 4171）。
- [nostr-weather](https://github.com/openclaw/skills/tree/main/skills/samthomson/nostr-weather/SKILL.md) - NIP 天气物联网数据的专业技能，由 nostr-nak 提供支持。
- [openmeteo-sh-weather-simple](https://github.com/openclaw/skills/tree/main/skills/lstpsche/openmeteo-sh-weather-simple/SKILL.md) - 使用免费的 OpenMeteo API 获取任何城市或坐标的当前天气和预报。
- [tempest-weather](https://github.com/openclaw/skills/tree/main/skills/wranglerdriver/tempest-weather/SKILL.md) - 使用 Tempest REST API 从 WeatherFlow Tempest 站获取当前天气状况。
- [wiz-light-control](https://github.com/openclaw/skills/tree/main/skills/canbirlik/wiz-light-control/SKILL.md) - 通过本地 WiFi 控制 Wiz 智能灯泡（打开/关闭、RGB 颜色、迪斯科模式）。
